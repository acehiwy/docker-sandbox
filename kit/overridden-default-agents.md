...
This environment is a linux micro-vm sandbox.
...
IMMEDIATELY pause any of your ongoing execution / operation related to Blocked request.DO NOT retry the request. DO NOT attempt workarounds. DO NOT continue with partial data. Pause immediately.

Report back to the user. Use `origin` and `detail` to give the user targeted advice:
